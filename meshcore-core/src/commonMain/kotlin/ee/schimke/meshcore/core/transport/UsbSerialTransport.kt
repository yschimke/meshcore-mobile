...
/**
 * Serial transport built on [dev.mcarr.usb][dev.mcarr.usb.interfaces.ISerialPortWrapper].
 * The port is opened in [connect] (with [baudRate] applied), read/write
 * go through the wrapper, and frames are wrapped with the shared
 * 0x3C/0x3E length-prefixed codec.
 */
